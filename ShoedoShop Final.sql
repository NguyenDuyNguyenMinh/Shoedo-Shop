...
-- =======================
-- SP 1: ShoeDo - SP1 - GD
(1, N'Đen', 'sp1_gd1_black.jpg', 10, N'Hiển thị', 10, 1000000), -- Size 40 (ID 10)
(1, N'Đen', 'sp1_gd1_black.jpg', 11, N'Hiển thị', 10, 1200000), -- Size 41 (ID 11)

-- SP 2: ShoeDo - SP2 - GD (Nữ)
(2, N'Trắng', 'sp2_gd2_white.jpg', 7, N'Hiển thị', 15, 1000000), -- Size 37 (ID 7)
(2, N'Trắng', 'sp2_gd2_white.jpg', 8, N'Hiển thị', 20, 1200000), -- Size 38 (ID 8)
(2, N'Trắng', 'sp2_gd2_white.jpg', 9, N'Hiển thị', 20, 1500000), -- Size 39 (ID 9)

-- SP 3: ShoeDo - SP3 - GD (Cao gót)
(3, N'Trắng', 'sp3_gd3_white.jpg', 7, N'Hiển thị', 10, 1000000), -- Size 37 (ID 7)
(3, N'Trắng', 'sp3_gd3_white.jpg', 8, N'Hiển thị', 15, 1200000), -- Size 38 (ID 8)
(3, N'Trắng', 'sp3_gd3_white.jpg', 9, N'Hiển thị', 10, 1300000), -- Size 39 (ID 9)

-- =======================
-- Giày sneaker (MaSP 4,5)
-- =======================
-- SP 4: ShoeDo - SP1 - GSK
(4, N'Đen', 'sp4_snk1_black.jpg', 10, N'Hiển thị', 10, 1500000), -- Size 40 (ID 10)
(4, N'Đen', 'sp4_snk1_black.jpg', 11, N'Hiển thị', 10, 1500000), -- Size 41 (ID 11)
(4, N'Đen', 'sp4_snk1_black.jpg', 12, N'Hiển thị', 10, 1500000), -- Size 42 (ID 12)
(4, N'Trắng', 'sp4_snk1_white.jpg', 10, N'Hiển thị', 10, 1300000), -- Size 40 (ID 10)
(4, N'Nâu', 'sp4_snk1_brown.jpg', 10, N'Hiển thị', 20, 1800000), -- Size 40 (ID 10)
(4, N'Nâu', 'sp4_snk1_brown.jpg', 11, N'Hiển thị', 20, 1800000), -- Size 41 (ID 11)
(4, N'Nâu', 'sp4_snk1_brown.jpg', 12, N'Hiển thị', 20, 1800000), -- Size 42 (ID 12)

-- SP 5: ShoeDo - SP2 - GSK
(5, N'Xanh lá', 'sp5_snk2_green.jpg', 10, N'Hiển thị', 20, 1500000), -- Size 40 (ID 10)
(5, N'Xanh lá', 'sp5_snk2_green.jpg', 11, N'Hiển thị', 20, 1500000), -- Size 41 (ID 11)
(5, N'Xanh lá', 'sp5_snk2_green.jpg', 12, N'Hiển thị', 20, 1500000), -- Size 42 (ID 12)
(5, N'Trắng be', 'sp5_snk2_white.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(5, N'Trắng be', 'sp5_snk2_white.jpg', 12, N'Hiển thị', 10, 1200000), -- Size 42 (ID 12)

-- =======================
-- Giày bóng đá (MaSP 6)
-- =======================
-- SP 6: ShoeDo - SP1 - GBD
(6, N'Hồng', 'sp6_gbd1_pink.jpg', 10, N'Hiển thị', 12, 1200000), -- Size 40 (ID 10)
(6, N'Hồng', 'sp6_gbd1_pink.jpg', 11, N'Hiển thị', 20, 1200000), -- Size 41 (ID 11)
(6, N'Hồng', 'sp6_gbd1_pink.jpg', 12, N'Hiển thị', 10, 1500000), -- Size 42 (ID 12)
(6, N'Hồng', 'sp6_gbd1_pink.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(6, N'Vàng', 'sp6_gbd1_yellow.jpg', 10, N'Hiển thị', 12, 1200000), -- Size 40 (ID 10)
(6, N'Vàng', 'sp6_gbd1_yellow.jpg', 11, N'Hiển thị', 20, 1200000), -- Size 41 (ID 11)

-- =======================
-- Giày sandal (MaSP 7)
-- =======================
-- SP 7: ShoeDo - SP1 - GSD
(7, N'Đen', 'sp7_gsd1_black.jpg', 7, N'Hiển thị', 18, 1800000), -- Size 37 (ID 7)
(7, N'Đen', 'sp7_gsd1_black.jpg', 8, N'Hiển thị', 18, 1800000), -- Size 38 (ID 8)
(7, N'Đen', 'sp7_gsd1_black.jpg', 9, N'Hiển thị', 18, 1800000), -- Size 39 (ID 9)
(7, N'Trắng', 'sp7_gsd1_white.jpg', 7, N'Hiển thị', 18, 1800000), -- Size 37 (ID 7)
(7, N'Trắng', 'sp7_gsd1_white.jpg', 8, N'Hiển thị', 18, 1800000), -- Size 38 (ID 8)
(7, N'Trắng', 'sp7_gsd1_white.jpg', 9, N'Hiển thị', 18, 1800000), -- Size 39 (ID 9)

-- =======================
-- Giày boot (MaSP 8)
-- =======================
-- SP 8: ShoeDo - SP1 - GBT
(8, N'Đen', 'sp8_b1_black.jpg', 8, N'Hiển thị', 15, 1900000), -- Size 38 (ID 8)
(8, N'Đen', 'sp8_b1_black.jpg', 10, N'Hiển thị', 15, 2000000), -- Size 40 (ID 10)
(8, N'Đen', 'sp8_b1_black.jpg', 12, N'Hiển thị', 15, 2100000), -- Size 42 (ID 12)
(8, N'Nâu', 'sp8_b1_brown.jpg', 8, N'Hiển thị', 15, 1900000), -- Size 38 (ID 8)
(8, N'Nâu', 'sp8_b1_brown.jpg', 10, N'Hiển thị', 15, 2000000), -- Size 40 (ID 10)
(8, N'Nâu', 'sp8_b1_brown.jpg', 12, N'Hiển thị', 15, 2100000), -- Size 42 (ID 12)

-- =======================
-- Giày boot + da
-- =======================
-- SP 9: ShoeDo - SP9 - GBT&GD
(9, N'Đen', 'sp9_bd1_black.jpg', 7, N'Hiển thị', 15, 1500000), -- Size 37 (ID 7)
(9, N'Đen', 'sp9_bd1_black.jpg', 8, N'Hiển thị', 15, 1500000), -- Size 38 (ID 8)
(9, N'Đen', 'sp9_bd1_black.jpg', 9, N'Hiển thị', 15, 1500000), -- Size 39 (ID 9)
(9, N'Đen', 'sp9_bd1_black.jpg', 10, N'Hiển thị', 15, 1500000), -- Size 40 (ID 10)

-- =======================
-- Phụ kiện (MaSP 10 → 15)
-- =======================
-- SP 10 - 12: Vớ (Dùng ID 1 = FreeSize)
(10, N'Đen', 'sp10_v1_black.jpg', 1, N'Hiển thị', 100, 70000), -- Free size (ID 1) 
(10, N'Trắng', 'sp10_v1_white.jpg', 1, N'Hiển thị', 100, 70000), -- Free size (ID 1)

(11, N'Đen', 'sp11_v2_black.jpg', 1, N'Hiển thị', 80, 150000), -- Free size (ID 1)
(11, N'Trắng', 'sp11_v2_white.jpg', 1, N'Hiển thị', 80, 150000), 

(12, N'Xám đen quân đội', 'sp12_v3_vip.jpg', 1, N'Hiển thị', 50, 180000), -- Free size (ID 1)

-- SP 13 - 15: Dây giày
(13, N'Đen', 'sp13_dg1_black.png', 1, N'Hiển thị', 100, 80000), -- Free size (ID 1)
(13, N'Trắng', 'sp13_dg1_white.png', 1, N'Hiển thị', 100, 80000), -- Free size (ID 1)

(14, N'Xanh biển', 'sp14_dg2_blue.png', 1, N'Hiển thị', 50, 150000), -- Free size (ID 1)
(14, N'Hồng', 'sp14_dg2_pink.png', 1, N'Hiển thị', 50, 150000), -- Free size (ID 1)
(14, N'Xanh lá', 'sp14_dg2_green.png', 1, N'Hiển thị', 50, 150000), -- Free size (ID 1)

(15, N'Đen', 'sp15_dg3_black.png', 1, N'Hiển thị', 80, 120000), -- Free size (ID 1)
(15, N'Trắng', 'sp15_dg3_white.png', 1, N'Hiển thị', 80, 120000), -- Free size (ID 1)
(15, N'Vàng', 'sp15_dg3_yellow.png', 1, N'Hiển thị', 80, 120000), -- Free size (ID 1)
(15, N'Đỏ', 'sp15_dg3_red.png', 1, N'Hiển thị', 80, 120000), -- Free size (ID 1)
(15, N'Xanh lá', 'sp15_dg3_green.png', 1, N'Hiển thị', 80, 120000), -- Free size (ID 1)

-- Sản phẩm thêm
-- Giày sandal
(16, N'Đen', 'sp16_gsd2_black.jpg', 10, N'Hiển thị', 10, 800000), -- Size 40 (ID 10)
(16, N'Đen', 'sp16_gsd2_black.jpg', 11, N'Hiển thị', 10, 850000), -- Size 41 (ID 11)
(16, N'Đen', 'sp16_gsd2_black.jpg', 12, N'Hiển thị', 10, 900000), -- Size 42 (ID 12)
(16, N'Đen', 'sp16_gsd2_black.jpg', 13, N'Hiển thị', 10, 1000000), -- Size 43 (ID 13)
(16, N'Xanh quân đội', 'sp16_gsd2_green.jpg', 10, N'Hiển thị', 10, 800000), -- Size 40 (ID 10)
(16, N'Xanh quân đội', 'sp16_gsd2_green.jpg', 11, N'Hiển thị', 10, 850000), -- Size 41 (ID 11)
(16, N'Xanh quân đội', 'sp16_gsd2_green.jpg', 12, N'Hiển thị', 10, 900000), -- Size 42 (ID 12)
(16, N'Xanh quân đội', 'sp16_gsd2_green.jpg', 13, N'Hiển thị', 10, 1000000), -- Size 43 (ID 13)

(17, N'Đen', 'sp17_gsd3_black.jpg', 10, N'Hiển thị', 10, 1000000), -- Size 40 (ID 10)
(17, N'Đen', 'sp17_gsd3_black.jpg', 11, N'Hiển thị', 10, 1100000), -- Size 41 (ID 11)
(17, N'Nâu', 'sp17_gsd3_brown.jpg', 10, N'Hiển thị', 10, 1000000), -- Size 40 (ID 10)
(17, N'Nâu', 'sp17_gsd3_brown.jpg', 11, N'Hiển thị', 10, 1100000), -- Size 41 (ID 11)
(17, N'Nâu', 'sp17_gsd3_brown.jpg', 12, N'Hiển thị', 10, 1200000), -- Size 42 (ID 12)
(17, N'Nâu', 'sp17_gsd3_brown.jpg', 13, N'Hiển thị', 10, 1300000), -- Size 43 (ID 13)

(18, N'Đen', 'sp18_gsd4_black.jpg', 10, N'Hiển thị', 10, 1500000), -- Size 40 (ID 10)
(18, N'Đen', 'sp18_gsd4_black.jpg', 11, N'Hiển thị', 10, 1800000), -- Size 41 (ID 11)
(18, N'Đen', 'sp18_gsd4_black.jpg', 12, N'Hiển thị', 10, 2000000), -- Size 42 (ID 12)
(18, N'Xanh quân đội', 'sp18_gsd4_green.jpg', 10, N'Hiển thị', 10, 1500000), -- Size 40 (ID 10)
(18, N'Xanh quân đội', 'sp18_gsd4_green.jpg', 11, N'Hiển thị', 10, 1800000), -- Size 41 (ID 11)
(18, N'Xanh quân đội', 'sp18_gsd4_green.jpg', 12, N'Hiển thị', 10, 2000000), -- Size 42 (ID 12)
(18, N'Trắng be', 'sp18_gsd4_white.jpg', 10, N'Hiển thị', 10, 1500000), -- Size 40 (ID 10)
(18, N'Trắng be', 'sp18_gsd4_white.jpg', 11, N'Hiển thị', 10, 1800000), -- Size 41 (ID 11)
(18, N'Trắng be', 'sp18_gsd4_white.jpg', 12, N'Hiển thị', 10, 2000000), -- Size 42 (ID 12)

(19, N'Đen', 'sp19_gsd5_black.jpg', 7, N'Hiển thị', 10, 1000000), -- Size 37 (ID 7)
(19, N'Đen', 'sp19_gsd5_black.jpg', 8, N'Hiển thị', 10, 1200000), -- Size 38 (ID 8)
(19, N'Đen', 'sp19_gsd5_black.jpg', 9, N'Hiển thị', 10, 1500000), -- Size 39 (ID 9)
(19, N'Trắng be', 'sp19_gsd5_white.jpg', 7, N'Hiển thị', 10, 1000000), -- Size 37 (ID 7)
(19, N'Trắng be', 'sp19_gsd5_white.jpg', 8, N'Hiển thị', 10, 1200000), -- Size 38 (ID 8)
(19, N'Trắng be', 'sp19_gsd5_white.jpg', 9, N'Hiển thị', 10, 1500000), -- Size 39 (ID 9)

(20, N'Đen', 'sp20_gsd6_black.jpg', 7, N'Hiển thị', 10, 1000000), -- Size 37 (ID 7)
(20, N'Đen', 'sp20_gsd6_black.jpg', 8, N'Hiển thị', 10, 1200000), -- Size 38 (ID 8)
(20, N'Đen', 'sp20_gsd6_black.jpg', 9, N'Hiển thị', 10, 1500000), -- Size 39 (ID 9)
(20, N'Trắng', 'sp20_gsd6_white.jpg', 7, N'Hiển thị', 10, 1000000), -- Size 37 (ID 7)
(20, N'Trắng', 'sp20_gsd6_white.jpg', 8, N'Hiển thị', 10, 1200000), -- Size 38 (ID 8)
(20, N'Trắng', 'sp20_gsd6_white.jpg', 9, N'Hiển thị', 10, 1500000), -- Size 39 (ID 9)

-- Giày da
(21, N'Đen', 'sp21_gd4_black.jpg', 7, N'Hiển thị', 10, 1000000), -- Size 37 (ID 7)
(21, N'Đen', 'sp21_gd4_black.jpg', 8, N'Hiển thị', 10, 1200000), -- Size 38 (ID 8)
(21, N'Đen', 'sp21_gd4_black.jpg', 9, N'Hiển thị', 10, 1500000), -- Size 39 (ID 9)
(21, N'Trắng be', 'sp21_gd4_white.jpg', 7, N'Hiển thị', 10, 1000000), -- Size 37 (ID 7)
(21, N'Trắng be', 'sp21_gd4_white.jpg', 8, N'Hiển thị', 10, 1200000), -- Size 38 (ID 8)
(21, N'Trắng be', 'sp21_gd4_white.jpg', 9, N'Hiển thị', 10, 1500000), -- Size 39 (ID 9)

(22, N'Đen', 'sp22_gd5_black.jpg', 11, N'Hiển thị', 10, 1500000), -- Size 41 (ID 11)
(22, N'Đen', 'sp22_gd5_black.jpg', 12, N'Hiển thị', 10, 1580000), -- Size 42 (ID 12)
(22, N'Nâu', 'sp22_gd5_brown.jpg', 11, N'Hiển thị', 10, 1500000), -- Size 41 (ID 11)
(22, N'Nâu', 'sp22_gd5_brown.jpg', 12, N'Hiển thị', 10, 1580000), -- Size 42 (ID 12)

(23, N'Đen', 'sp23_gd6_black.jpg', 11, N'Hiển thị', 10, 1000000), -- Size 41 (ID 11)
(23, N'Đen', 'sp23_gd6_black.jpg', 12, N'Hiển thị', 10, 1100000), -- Size 42 (ID 12)
(23, N'Nâu', 'sp23_gd6_brown.jpg', 10, N'Hiển thị', 10, 900000), -- Size 40 (ID 10)
(23, N'Nâu', 'sp23_gd6_brown.jpg', 11, N'Hiển thị', 10, 1000000), -- Size 41 (ID 11)
(23, N'Nâu', 'sp23_gd6_brown.jpg', 12, N'Hiển thị', 10, 1100000), -- Size 42 (ID 12)

(24, N'Đen', 'sp24_gd7_black.jpg', 8, N'Hiển thị', 10, 1500000), -- Size 38 (ID 8)
(24, N'Đen', 'sp24_gd7_black.jpg', 9, N'Hiển thị', 10, 1700000), -- Size 39 (ID 9)
(24, N'Đen', 'sp24_gd7_black.jpg', 10, N'Hiển thị', 10, 1800000), -- Size 40 (ID 10)

(25, N'Đen', 'sp25_gd8_black.jpg', 7, N'Hiển thị', 10, 1200000), -- Size 37 (ID 7)
(25, N'Đen', 'sp25_gd8_black.jpg', 8, N'Hiển thị', 10, 1400000), -- Size 38 (ID 8)
(25, N'Đen', 'sp25_gd8_black.jpg', 9, N'Hiển thị', 10, 1600000), -- Size 39 (ID 9)
(25, N'Trắng be', 'sp25_gd8_white.jpg', 7, N'Hiển thị', 10, 1200000), -- Size 37 (ID 7)
(25, N'Trắng be', 'sp25_gd8_white.jpg', 8, N'Hiển thị', 10, 1400000), -- Size 38 (ID 8)
(25, N'Trắng be', 'sp25_gd8_white.jpg', 9, N'Hiển thị', 10, 1600000), -- Size 39 (ID 9)

-- Giày boot
(26, N'Xám', 'sp26_b2_black.jpg', 8, N'Hiển thị', 5, 1800000), -- Size 38 (ID 8)
(26, N'Xám', 'sp26_b2_black.jpg', 9, N'Hiển thị', 5, 2000000), -- Size 39 (ID 9)
(26, N'Xám', 'sp26_b2_black.jpg', 10, N'Hiển thị', 5, 2200000), -- Size 40 (ID 10)

(27, N'Trắng be', 'sp27_b3_white.jpg', 8, N'Hiển thị', 10, 500000), -- Size 38 (ID 8)
(27, N'Trắng be', 'sp27_b3_white.jpg', 9, N'Hiển thị', 10, 600000), -- Size 39 (ID 9)
(27, N'Trắng be', 'sp27_b3_white.jpg', 10, N'Hiển thị', 10, 700000), -- Size 40 (ID 10)
(27, N'Trắng be', 'sp27_b3_white.jpg', 11, N'Hiển thị', 10, 800000), -- Size 41 (ID 11)
(27, N'Trắng be', 'sp27_b3_white.jpg', 12, N'Hiển thị', 10, 900000), -- Size 42 (ID 12)

-- Giày boot & da
(28, N'Nâu', 'sp28_bd2_brown.jpg', 10, N'Hiển thị', 5, 1500000), -- Size 40 (ID 10)
(28, N'Nâu', 'sp28_bd2_brown.jpg', 11, N'Hiển thị', 5, 1800000), -- Size 41 (ID 11)
(28, N'Nâu', 'sp28_bd2_brown.jpg', 12, N'Hiển thị', 5, 2000000), -- Size 42 (ID 12)

(29, N'Đen', 'sp29_bd3_black.jpg', 9, N'Hiển thị', 10, 2100000), -- Size 39 (ID 9)
(29, N'Nâu', 'sp29_bd3_brown.jpg', 7, N'Hiển thị', 10, 1700000), -- Size 37 (ID 7)
(29, N'Nâu', 'sp29_bd3_brown.jpg', 8, N'Hiển thị', 10, 1900000), -- Size 38 (ID 8)
(29, N'Nâu', 'sp29_bd3_brown.jpg', 9, N'Hiển thị', 10, 2100000), -- Size 39 (ID 9)

(30, N'Nâu đậm', 'sp30_bd4_brown.jpg', 10, N'Hiển thị', 10, 1500000), -- Size 40 (ID 10)
(30, N'Nâu đậm', 'sp30_bd4_brown.jpg', 11, N'Hiển thị', 10, 1650000), -- Size 41 (ID 11)
(30, N'Nâu đậm', 'sp30_bd4_brown.jpg', 12, N'Hiển thị', 10, 1780000), -- Size 42 (ID 12)

-- Giày sneaker
(31, N'Đen', 'sp31_snk2_black.jpg', 10, N'Hiển thị', 5, 1000000), -- Size 40 (ID 10)
(31, N'Đen', 'sp31_snk2_black.jpg', 11, N'Hiển thị', 5, 1250000), -- Size 41 (ID 11)
(31, N'Đen', 'sp31_snk2_black.jpg', 12, N'Hiển thị', 5, 1500000), -- Size 42 (ID 12)

(32, N'Đen', 'sp32_snk3_black.jpg', 10, N'Hiển thị', 10, 1000000), -- Size 40 (ID 10)
(32, N'Đen', 'sp32_snk3_black.jpg', 11, N'Hiển thị', 10, 1200000), -- Size 41 (ID 11)
(32, N'Đen', 'sp32_snk3_black.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(32, N'Trắng be nhạt', 'sp32_snk3_white.jpg', 10, N'Hiển thị', 10, 1000000), -- Size 40 (ID 10)
(32, N'Trắng be nhạt', 'sp32_snk3_white.jpg', 11, N'Hiển thị', 10, 1200000), -- Size 41 (ID 11)
(32, N'Trắng be nhạt', 'sp32_snk3_white.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)

(33, N'Trắng', 'sp33_snk4_be.jpg', 10, N'Hiển thị', 10, 1000000), -- Size 40 (ID 10)
(33, N'Trắng', 'sp33_snk4_be.jpg', 11, N'Hiển thị', 10, 1200000), -- Size 41 (ID 11)
(33, N'Trắng', 'sp33_snk4_be.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(33, N'Trắng be', 'sp33_snk4_white.jpg', 10, N'Hiển thị', 10, 1000000), -- Size 40 (ID 10)
(33, N'Trắng be', 'sp33_snk4_white.jpg', 11, N'Hiển thị', 10, 1200000), -- Size 41 (ID 11)
(33, N'Trắng be', 'sp33_snk4_white.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)

(34, N'Đen', 'sp34_snk5_black.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(34, N'Đen', 'sp34_snk5_black.jpg', 11, N'Hiển thị', 10, 1500000), -- Size 41 (ID 11)
(34, N'Trắng be', 'sp34_snk5_white.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(34, N'Trắng be', 'sp34_snk5_white.jpg', 11, N'Hiển thị', 10, 1500000), -- Size 41 (ID 11)

(35, N'Đen', 'sp35_snk6_black.jpg', 9, N'Hiển thị', 10, 1200000), -- Size 39 (ID 9)
(35, N'Đen', 'sp35_snk6_black.jpg', 10, N'Hiển thị', 10, 1400000), -- Size 40 (ID 10)
(35, N'Đen', 'sp35_snk6_black.jpg', 11, N'Hiển thị', 10, 1500000), -- Size 41 (ID 11)
(35, N'Đỏ', 'sp35_snk6_red.jpg', 9, N'Hiển thị', 10, 1200000), -- Size 39 (ID 9)
(35, N'Đỏ', 'sp35_snk6_red.jpg', 11, N'Hiển thị', 10, 1200000), -- Size 41 (ID 11)

(36, N'Nâu', 'sp36_snk7_brown.jpg', 10, N'Hiển thị', 10, 1700000), -- Size 40 (ID 10)
(36, N'Nâu', 'sp36_snk7_brown.jpg', 11, N'Hiển thị', 10, 1900000), -- Size 41 (ID 11)
(36, N'Nâu', 'sp36_snk7_brown.jpg', 12, N'Hiển thị', 10, 2100000), -- Size 42 (ID 12)

(37, N'Trắng xanh', 'sp37_snk8_white.jpg', 8, N'Hiển thị', 10, 1300000), -- Size 38 (ID 8)
(37, N'Trắng xanh', 'sp37_snk8_white.jpg', 9, N'Hiển thị', 10, 1500000), -- Size 39 (ID 9)
(37, N'Trắng xanh', 'sp37_snk8_white.jpg', 10, N'Hiển thị', 10, 1700000), -- Size 40 (ID 10)
(37, N'Trắng xanh', 'sp37_snk8_white.jpg', 11, N'Hiển thị', 10, 1900000), -- Size 41 (ID 11)
(37, N'Trắng xanh', 'sp37_snk8_white.jpg', 12, N'Hiển thị', 10, 2100000), -- Size 42 (ID 12)

-- Giày bóng đá
(38, N'Đen đỏ', 'sp38_gbd2_black.jpg', 10, N'Hiển thị', 10, 1500000), -- Size 40 (ID 10)
(38, N'Đen đỏ', 'sp38_gbd2_black.jpg', 11, N'Hiển thị', 10, 1600000), -- Size 41 (ID 11)
(38, N'Đen đỏ', 'sp38_gbd2_black.jpg', 12, N'Hiển thị', 10, 1700000), -- Size 42 (ID 12)
(38, N'Đen đỏ', 'sp38_gbd2_black.jpg', 13, N'Hiển thị', 10, 1800000), -- Size 43 (ID 13)
(38, N'Trắng xanh', 'sp38_gbd2_white.jpg', 10, N'Hiển thị', 10, 1500000), -- Size 40 (ID 10)
(38, N'Trắng xanh', 'sp38_gbd2_white.jpg', 11, N'Hiển thị', 10, 1600000), -- Size 41 (ID 11)

(39, N'Đen bạc', 'sp39_gbd3_black.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(39, N'Đen bạc', 'sp39_gbd3_black.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(39, N'Xanh nhạt', 'sp39_gbd3_blue.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(39, N'Xanh nhạt', 'sp39_gbd3_blue.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(39, N'Xanh navy', 'sp39_gbd3_bluenavy.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(39, N'Xanh navy', 'sp39_gbd3_bluenavy.jpg', 11, N'Hiển thị', 10, 1300000), -- Size 41 (ID 11)
(39, N'Xanh navy', 'sp39_gbd3_bluenavy.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(39, N'Xanh navy', 'sp39_gbd3_bluenavy.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(39, N'Xanh lá chuối', 'sp39_gbd3_green.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(39, N'Xanh lá chuối', 'sp39_gbd3_green.jpg', 11, N'Hiển thị', 10, 1300000), -- Size 41 (ID 11)
(39, N'Xanh lá chuối', 'sp39_gbd3_green.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(39, N'Xanh lá chuối', 'sp39_gbd3_green.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(39, N'Cam đen', 'sp39_gbd3_orange.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(39, N'Cam đen', 'sp39_gbd3_orange.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(39, N'Cam đen', 'sp39_gbd3_orange.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)

(40, N'Đen xám', 'sp40_gbd4_black.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(40, N'Đen xám', 'sp40_gbd4_black.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(40, N'Xanh nhạt', 'sp40_gbd4_blue.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(40, N'Xanh nhạt', 'sp40_gbd4_blue.jpg', 11, N'Hiển thị', 10, 1300000), -- Size 41 (ID 11)
(40, N'Xanh nhạt', 'sp40_gbd4_blue.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(40, N'Xanh nhạt', 'sp40_gbd4_blue.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(40, N'Xanh navy', 'sp40_gbd4_bluenavy.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(40, N'Xanh navy', 'sp40_gbd4_bluenavy.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(40, N'Cam bạc', 'sp40_gbd4_silver.jpg', 10, N'Hiển thị', 10, 1200000), -- Size 40 (ID 10)
(40, N'Cam bạc', 'sp40_gbd4_silver.jpg', 11, N'Hiển thị', 10, 1300000), -- Size 41 (ID 11)
(40, N'Cam bạc', 'sp40_gbd4_silver.jpg', 13, N'Hiển thị', 10, 1500000), -- Size 43 (ID 13)
(40, N'Trắng xanh', 'sp40_gbd4_white.jpg', 11, N'Hiển thị', 10, 1300000), -- Size 41 (ID 11)
(40, N'Trắng xanh', 'sp40_gbd4_white.jpg', 12, N'Hiển thị', 10, 1400000), -- Size 42 (ID 12)
(40, N'Trắng xanh', 'sp40_gbd4_white.jpg', 13, N'Hiển thị', 10, 1500000); -- Size 43 (ID 13)
