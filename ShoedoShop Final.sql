...
INSERT INTO HoaDon (MaKH, MaQT, PhuongThucTT, DiaChiJson, TrangThai, DaTruKho, GhiChu, NgayMua, NgayDen) VALUES
-- HD 1: COD từ chối ở ĐXửLý → chưa trừ kho
(1, 1, N'COD',
 N'{"DiemGiao":"123 Nguyễn Huệ A, Q1","TenNN":"Nguyễn Văn A","SDT":"0901234567"}',
 N'Đã từ chối', 0, N'Đơn hàng đặt số lượng quá lớn nhân viên miễn cưỡng từ chối vì gọi không ghe máy', '2025-01-10', NULL),

-- HD 2: VNPay đang xử lý → đã trừ kho khi checkout
(2, NULL, N'Chuyển khoản',
 N'{"DiemGiao":"789 Cách Mạng Tháng 8Z, Tân Bình","TenNN":"Trần Thị Hi A","SDT":"0912345678"}',
 N'Đang xử lý', 1, NULL, '2026-01-11', NULL),

-- HD 3: COD đang giao → đã trừ kho khi confirm
(3, 1, N'COD',
 N'{"DiemGiao":"456 Lê Lợi A, Q1","TenNN":"Nguyễn Văn A","SDT":"0901234567"}',
 N'Đang giao', 1, NULL, '2026-01-12', NULL),

-- HD 4: COD hoàn tất → đã trừ kho khi confirm
(4, 1, N'COD',
 N'{"DiemGiao":"Quận Cam A","TenNN":"Nguyễn Văn A","SDT":"0901234567"}',
 N'Hoàn tất', 1, NULL, '2026-01-13', '2026-03-25'),

-- HD 5: COD từ chối ở ĐXửLý → chưa trừ kho
(1, 1, N'COD',
 N'{"DiemGiao":"123 Nguyễn Huệ B","TenNN":"Nguyễn Văn A-B","SDT":"0901234567"}',
 N'Đã từ chối', 0, N'Khách hủy đơn', '2026-01-14', NULL),

-- HD 6: VNPay báo lỗi → đã trừ kho khi checkout
(2, 1, N'Chuyển khoản',
 N'{"DiemGiao":"789 Cách Mạng Tháng 8Y","TenNN":"Trần Thị Hi B","SDT":"0912345678"}',
 N'Báo lỗi', 1, N'Khách hàng không nhận được hàng', '2026-01-15', '2026-01-19'),

-- HD 7: COD báo lỗi → đã trừ kho khi confirm (đã giao)
(3, 1, N'COD',
 N'{"DiemGiao":"456 Lê Lợi B","TenNN":"Nguyễn Văn A-B","SDT":"0901234567"}',
 N'Báo lỗi', 1, N'Mũi giày bị móp', '2026-01-16', '2026-01-20'),

-- HD 8: COD đang giao → đã trừ kho khi confirm
(4, 1, N'COD',
 N'{"DiemGiao":"Quận Cam B","TenNN":"Nguyễn Văn B","SDT":"0901234567"}',
 N'Đang giao', 1, NULL, '2026-01-17', NULL),

-- HD 9: COD đang xử lý → chưa trừ kho
(1, NULL, N'COD',
 N'{"DiemGiao":"123 Nguyễn Huệ C","TenNN":"Nguyễn Văn A-C","SDT":"0901234567"}',
 N'Đang xử lý', 0, NULL, '2026-01-18', NULL),

-- HD 10: VNPay hoàn tất → đã trừ kho khi checkout
(2, 1, N'Chuyển khoản',
 N'{"DiemGiao":"789 Cách Mạng Tháng 8Z","TenNN":"Trần Thị Hi A","SDT":"0912345678"}',
 N'Hoàn tất', 1, NULL, '2026-01-19', '2026-01-24');
